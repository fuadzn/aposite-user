  ...
  searchInputInputfield.on("keyup", function (e) {
    ...
    if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
      ...
      if (value != "") {
        ...
        '<a href="#" class="pb-25">' +
        '<h6 class="text-primary mb-0">Pasien</h6>' +
        '</a>' +
        '</li>',
        $activeItemClass = "",
        $bookmarkIcon = "",
        ...
        $.getJSON(baseurl+"beranda/search/"+value, function (data) {
          for (var i = 0; i < data.listItems.length; i++) {
            $startList += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="'+baseurl+'rekam_medis/pasien/detail/'+data.listItems[i].no_medrec+'"><div class="d-flex justify-content-start align-items-center"><span class="mr-75" data-icon="">'+data.listItems[i].no_cm+' - '+data.listItems[i].name+'</span></div></a></li>';
          }
