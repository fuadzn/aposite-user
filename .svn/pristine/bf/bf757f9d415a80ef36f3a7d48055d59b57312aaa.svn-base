               ...
               <div class="col-lg">
                    <div class="p-5 ">
                         ...
                         <div class="card-block p-b-15 ">
                              <?= validation_errors() ?>
                              <form id="input_siswa">
                                   <?php foreach ($nuptk as $row) { ?>
                                        <div class="form-group row">
                                             <div class="col-sm-12 mb-1">
                                                  <input type="text" class="form-control" name="nuptk" id="nuptk" required style="border-radius:20px; height:40px;" value="<?= $row->nuptk; ?>" hidden>
...
event.preventDefault();
    $.ajax({
        url: "<?php echo site_url('Login_portal/reset_password_validation') ?>",
        type: 'POST',
        dataType: 'json',
        data: $(this).serialize(),
