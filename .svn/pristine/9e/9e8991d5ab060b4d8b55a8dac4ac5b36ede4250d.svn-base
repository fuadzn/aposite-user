               ...
               <div class="col-lg">
                    <div class="p-5 ">
                         <div class="text-center">
                              <h1 class="h4 text-gray-900 mb-4">Form Ganti Password</h1>
                         </div>
                              ...
                              <form id="input_siswa">
                                   <div class="form-group row">
                                        ...
                                        foreach ($email as $row) {?>
                                             <input type="text" class="form-control" name="email" id="email" required style="border-radius:20px; height:40px;" value="<?=$row->email;
                                              }?>" hidden>
                                             
                                        </div>
                                        <div class="col-sm-12 mb-1">
                                             <input type="text" class="form-control" name="reset_key" id="reset_key" required style="border-radius:20px; height:40px;" value="<?php echo $reset_key?>" hidden>
                                        </div>
                                        <div class="col-sm-12 mb-1">
...
event.preventDefault();
    $.ajax({
        url: "<?php echo site_url('Lupa_password/reset_password_validation') ?>",
        type: 'POST',
        dataType: 'json',
        data: $(this).serialize(),
