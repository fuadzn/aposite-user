                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("minlength") !== undefined) {
                            message = "Terlalu Pendek: Minimal '" + $this.attr("minlength") + "' karakter<!-- data-validation-minlength-message to override -->";
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "Bukan email yang benar<!-- data-validation-email-message to override -->";
        ...
        validatorTypes: {
            ...
            email: {
                ...
                init: function ($this, name) {
                    ...
                    var message = "Bukan email yang benar";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
            ...
            match: {
                ...
                init: function ($this, name) {
                    ...
                    var message = "Harus sama dengan field";
                    var $label = null;
