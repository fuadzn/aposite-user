...
<body class="horizontal-layout 2-columns footer-static pace-done horizontal-menu navbar-sticky menu-expanded" data-open="hover" data-menu="horizontal-menu" data-col="2-columns" data-shepherd-step="step-1">

    <!-- BEGIN: Header-->
    <nav class="header-navbar navbar-expand-lg navbar navbar-with-menu navbar-fixed navbar-shadow navbar-brand-center" style="background-color:#002b80;">
        <div class="navbar-header d-xl-block d-none">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item">
                <center><img src="<?= site_url(); ?>assets/images/logo-kominfo.png" style="width: 35px; "></img></center>
                </li>
            </ul>
        </div>
                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                        ...
                        <a class="navbar-brand" href="<?= site_url(); ?>">
                            ...
                            <img src="<?= site_url(); ?>assets/images/kemendikbud.png" style="width: 35px;"></img>
                        </a>
                        <span class="user-name float-left text-bold-600 text-white col-md-12 ">KEMDIKBUD</span>
                            
                        <!-- <span class="user-name text-bold-600 text-white"><?= $this->load->get_var("user_info")->nm_klinik; ?></span> -->
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <!-- <li class="nav-item nav-search">
                            ...
                            <div class="search-input">
                                <form action="<?= site_url(); ?>rekam_medis/pasien" method="post">
                                    <div class="search-input-icon"><i class="feather icon-search primary"></i></div>
                                    <input class="input" type="text" placeholder="Klik Untuk RM, Enter Untuk Nama" tabindex="-1" data-search="template-list" name="cari_header" autocomplete="off">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                ...
                                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">
                                        <font color="#ffffff"><?= $user_info->name; ?></font>
                                    </span><span class="user-status">
                                            <font color="#ffffff"><?php if($user_info->roleid == 11){ 
                                            echo 'Admin Reg Provinsi '.$user_info->nm_provinsi; 
                                        } else if($user_info->roleid == 10){
                                            echo 'Admin Reg Kota '.$user_info->nama_region; 
                                        } else if($user_info->roleid == 9){
                                            echo 'Admin '.$user_info->nm_sekolah; 
                                         } else{
                                             echo 'Available';
                                         } ?>
                                            </font>
                                ...
                                <!--  <span>
                                    <img class="round" src="<?= site_url(); ?>app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40">
                                </span> -->
                                    
                                <span class="avatar bg-info mr-1">
                                    <div class="avatar-content">
                                        <?= substr($user_info->name, 0, 1); ?>
                                    </div>
                                </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="<?php echo site_url('user/change_password'); ?>"><i class="fa fa-key"></i> Ubah Password</a><!-- <a class="dropdown-item" href="javascript:;"><i class="feather icon-user"></i> Edit Profile</a><a class="dropdown-item" href="javascript:;"><i class="feather icon-mail"></i> My Inbox</a><a class="dropdown-item" href="javascript:;"><i class="feather icon-check-square"></i> Task</a><a class="dropdown-item" href="javascript:;"><i class="feather icon-message-square"></i> Chats</a> -->
                                <div class="dropdown-divider"></div><a class="dropdown-item" href="<?php echo site_url('logout'); ?>"><i class="feather icon-power"></i> Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <ul class="main-search-list-defaultlist d-none">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
                <div class="d-flex">
                    <div class="mr-50"><img src="<?= site_url(); ?>app-assets/images/icons/xls.png" alt="png" height="32"></div>
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
                <div class="d-flex">
                    <div class="mr-50"><img src="<?= site_url(); ?>app-assets/images/icons/jpg.png" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
                <div class="d-flex">
                    <div class="mr-50"><img src="<?= site_url(); ?>app-assets/images/icons/pdf.png" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
                <div class="d-flex">
                    <div class="mr-50"><img src="<?= site_url(); ?>app-assets/images/icons/doc.png" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-50"><img src="<?= site_url(); ?>app-assets/images/portrait/small/avatar-s-8.jpg" alt="png" height="32"></div>
                    <div class="search-data">
                        <p class="search-data-title mb-0"><?= $user_info->name; ?></p><small class="text-muted">UI designer</small>
                    </div>
                </div>
            </a></li>
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-50"><img src="<?= site_url(); ?>app-assets/images/portrait/small/avatar-s-1.jpg" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-50"><img src="<?= site_url(); ?>app-assets/images/portrait/small/avatar-s-14.jpg" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-50"><img src="<?= site_url(); ?>app-assets/images/portrait/small/avatar-s-6.jpg" alt="png" height="32"></div>
                    <div class="search-data">
    ...
    <div class="horizontal-menu-wrapper">
        <div class="header-navbar navbar-expand-sm navbar navbar-horizontal sticky-nav navbar-light navbar-without-dd-arrow navbar-shadow menu-border" role="navigation" data-menu="menu-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    <li class="nav-item mr-auto"><a class="navbar-brand" href="<?= site_url(); ?>">
                            <div class="brand-logo"></div>
                            <h2 class="brand-text mb-0">INTENS</h2>
                        </a></li>
            ...
            <div class="navbar-container main-menu-content" data-menu="menu-container">
                <!-- include <?= site_url(); ?>includes/mixins-->
