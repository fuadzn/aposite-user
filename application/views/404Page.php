...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=site_url();?>app-assets/css/pages/error.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="<?=site_url();?>app-assets/images/pages/404.png" class="img-fluid align-self-center" alt="branding logo">
                                    ...
                                    <a class="btn btn-primary btn-lg mt-2" href="javascript:;" onClick="goBack()">Back</a>
                                    <a class="btn btn-primary btn-lg mt-2" href="<?=site_url();?>">Home</a>
                                </div>
                            </div>
                        </div>
                    </div>
